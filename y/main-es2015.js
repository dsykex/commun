...
let HomeComponent = class HomeComponent {
    ...
    ngOnInit() {
        firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().onAuthStateChanged(authData => {
            ...
            if (authData) {
                ...
                this.hasUser = false;
                this.formdata = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
    ...
    login() {
        firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().signInWithEmailAndPassword(this.user.email, this.user.password).then(() => {
    ...
    join() {
        if (this.user.email && this.user.first_name && this.user.last_name && this.user.password && this.user.conf_password) {
            if (this.user.password == this.user.conf_password) {
                ...
                firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().createUserWithEmailAndPassword(this.user.email, this.user.password).then(() => {
                    let newUser = {
